...
import io.roaring.example.companyinfo.invoker.auth.Authentication;
import io.roaring.example.companyinfo.invoker.auth.HttpBasicAuth;
import io.roaring.example.companyinfo.invoker.auth.HttpBearerAuth;
import io.roaring.example.companyinfo.invoker.auth.ApiKeyAuth;
import io.roaring.example.companyinfo.invoker.auth.OAuth;
import io.roaring.example.companyinfo.invoker.auth.RetryingOAuth;
import io.roaring.example.companyinfo.invoker.auth.OAuthFlow;
...
public class ApiClient {
    ...
    private String basePath = "https://api.roaring.io/se/company/overview/2.0";
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://api.roaring.io/token";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.roaring.io/se/company/overview/2.0
     ...
     * @return a {@link io.roaring.example.companyinfo.invoker.ApiClient} object
     */
    ...
    */
     ...
     * @throws io.roaring.example.companyinfo.invoker.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws io.roaring.example.companyinfo.invoker.ApiException If fail to serialize the given object
     */
     ...
     * @throws io.roaring.example.companyinfo.invoker.ApiException If fail to read file content from response and write to disk
     ...
     * @throws io.roaring.example.companyinfo.invoker.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws io.roaring.example.companyinfo.invoker.ApiException If the response has an unsuccessful status code or
     ...
     * @throws io.roaring.example.companyinfo.invoker.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws io.roaring.example.companyinfo.invoker.ApiException If fails to update the parameters
     */
     ...
     * @throws io.roaring.example.companyinfo.invoker.ApiException If fail to serialize the request body object into a string
     */
